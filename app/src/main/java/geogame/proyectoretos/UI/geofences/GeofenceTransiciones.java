...
import geogame.proyectoretos.UI.MapPrincActivity;
...
public class GeofenceTransiciones extends IntentService {
    ...
    private static final String TAG = GeofenceTransiciones.class.getSimpleName();

    public static final int GEOFENCE_NOTIFICATION_ID = 0;

    public GeofenceTransiciones() {
        super(TAG);
    }
    ...
    private void sendNotification( String msg ) {
        ...
        Intent notificationIntent = MapPrincActivity.makeNotificationIntent(
